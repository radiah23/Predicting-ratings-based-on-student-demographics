...
data <- cleaned_name_school |>
  mutate(econ_disadvantaged = as.numeric( str_replace_all(percent_economically_disadvantaged , "[^0-9.]", "")))
data
>>>>>>> 8da4adcdba1d2827f7f3c733a4691d9948e796bb
```
...
=======
 select(district , econ_disadvantaged)|>
  group_by(district) |>
  summarise(avg_disadvantaged = mean(econ_disadvantaged, na.rm = TRUE)) |>
>>>>>>> 8da4adcdba1d2827f7f3c733a4691d9948e796bb
...
final_df <- filtered_df_pivoted |>
  ...
  summarise(
    ...
    econ_disadvantaged = first(econ_disadvantaged),
