...
ggplot(plot_p, aes(x=P_value, y = Predictors))+
  ...
  labs(x= "P-Value", y = "Predictors", title= "Significance of Predictors")+
  theme_minimal()+
  theme(axis.text.y = element_text(angle = 35, hjust = 1),plot.title = element_text(hjust = 0.5, face = "bold"))
```
